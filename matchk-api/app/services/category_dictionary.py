...
CATEGORIES: dict[str, dict] = {
    "beach": {
        ...
        "triggers": {
            "ko": ["바다", "해변", "해수욕장", "바닷가"],
            "en": ["beach", "sea", "coast", "shore", "seaside"],
            "ja": ["海", "ビーチ", "海水浴場", "海辺"],
            "zh": ["海边", "海滩", "海水浴场", "大海"],
        },
    },
    ...
    "market": {
        ...
        "triggers": {
            "ko": ["시장", "전통시장", "재래시장"],
            "en": ["market", "traditional market", "street food"],
            "ja": ["市場", "伝統市場", "屋台"],
            "zh": ["市场", "传统市场", "小吃"],
        },
    },
    ...
    "viewpoint": {
        ...
        "triggers": {
            "ko": ["전망대", "야경", "전망", "뷰"],
            "en": ["view", "viewpoint", "observatory", "night view"],
            "ja": ["展望台", "夜景", "眺め"],
            "zh": ["观景台", "夜景", "景观"],
        },
    },
